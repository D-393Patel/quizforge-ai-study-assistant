...
import { generationRequestSchema, quizSchema } from './quiz';
...
describe('quizSchema', () => {
  ...
  it('rejects study sets above the reliable combined item limit', () => expect(generationRequestSchema.safeParse({
    notes: 'These notes contain enough detail to generate a useful study set.',
    difficulty: 'medium',
    flashcardCount: 15,
    questionCount: 15,
  }).success).toBe(false));
